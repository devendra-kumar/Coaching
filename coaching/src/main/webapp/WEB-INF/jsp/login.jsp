...
<div>
 <span style=" position: absolute; visibility: visible;margin-top:610px;margin-left:300px;text-align:center;font-size: 14px;">
	<div id="copyright">Copyright &copy; 2017 
		<spring:message code="institute.name"/>. All Rights Reserved.&nbsp;
			<a title="Privacy Policy" href="https://colorlib.com/wp/privacy-policy/" target="_blank" style="text-decoration: none;">Privacy Policy</a>&nbsp;| <a title="Terms and Conditions" href="https://colorlib.com/wp/terms-conditions/" target="_blank" style="text-decoration: none;">www.dvionlinetest.in</a>
	</div>
</span> 
 <div role="navigation">
	...
	<div><marquee behavior="alternate"><font color="red">Website Under Maintenance</marquee></font></div>
	<div class="pull-right" style="padding-right:20px;margin-top:20%;">
         <ul class="social">
...
<%--  <div id="footer-bottom" class="clr"data-position="fixed"  style="text-align:center;margin-top:100px;">
	<div id="footer-bottom-inner" class="container clr"  >
		<div id="copyright" class="clr" role="contentinfo">Copyright &copy; 2017 
			<spring:message code="institute.name"/>. All Rights Reserved.&nbsp;
				<a title="Privacy Policy" href="https://colorlib.com/wp/privacy-policy/" target="_blank" style="text-decoration: none;">Privacy Policy</a>&nbsp;| <a title="Terms and Conditions" href="https://colorlib.com/wp/terms-conditions/" target="_blank" style="text-decoration: none;">www.dvionlinetest.in</a></div><!-- #copyright -->
