...
public class CandidateRegistrationController {
	...
	public String create(@ModelAttribute QuestionDTO questionDTO,
			@RequestParam("files") MultipartFile[] files,@RequestParam("language") String language,@RequestParam("type") String type,
			BindingResult bindingResult,HttpServletRequest request,Locale locale,Model model){
		String rootPath = request.getRealPath("/");
		questionDTO = questionService.create(questionDTO,files,language,type,rootPath);
		return "questionForm";
